...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Sign In",
      description: "Sign in using your Tweetter account.",
    },
    {
      heading: "Schadule your tweets",
      description: "Schadule what you want to be posted.",
    },
    {
      heading: "Enjoy",
      description: "Enjoy your time and we will do the rest for you!",
    },
  ];
