...
export default () => {
	const [tweetContent, setTweetContent] = useState('Tweet content here');
	const [time, setTime] = useState(new moment().format());
					...
					<div tw="mx-auto max-w-4xl">
						...
						<form>
							...
							<InputContainer tw="flex-1">
								...
								<DatePicker name="time" initialValue={time} handleChange={setTime} />
							</InputContainer>
